...
type RootStackParamList = {
  CommericialPage: { productId: number };
  // ...other routes if needed
};
type VehiclesScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'CommericialPage'>;
...
export default function CommericialPage(): JSX.Element {
    ...
    <View style={styles.container}>
      <View style={{ padding: 16 }}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.sectionTitle}>Commericial Vehicles</Text>
        </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate('CommericialPage', { productId: item.id })
              }
            >
