...
type RootStackParamList = {
  AdventurePage: { productId: number };
};
type VehiclesScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'AdventurePage'>;
...
export default function AdventurePage(): JSX.Element {
    ...
    <View style={styles.container}>
      <View style={{ padding: 16 }}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.sectionTitle}>Adventure Vehicles</Text>
        </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate('AdventurePage', { productId: item.id })
              }
            >
