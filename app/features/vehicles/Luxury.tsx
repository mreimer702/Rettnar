...
type RootStackParamList = {
  LuxuryPage: { productId: number };
  // ...other routes if needed
};
type VehiclesScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'LuxuryPage'>;
...
export default function LuxuryPage(): JSX.Element {
    ...
    <View style={styles.container}>
      <View style={{ padding: 16 }}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.sectionTitle}>Luxury Vehicles</Text>
        </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate('LuxuryPage', { productId: item.id })
              }
            >
