...
type RootStackParamList = {
  PersonalPage: { productId: number };
  // ...other routes if needed
};
type VehiclesScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'PersonalPage'>;
    ...
    <View style={styles.container}>
      <View style={{ padding: 16 }}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.sectionTitle}>Personal Vehicles</Text>
        </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate('PersonalPage', { productId: item.id })
              }
            >
