...
type RootStackParamList = {
  SpecialPage: { productId: number };
  // ...other routes if needed
};
type VehiclesScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'SpecialPage'>;
...
export default function SpecialPage(): JSX.Element {
    ...
    <View style={styles.container}>
      <View style={{ padding: 16 }}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.sectionTitle}>Special Vehicles</Text>
        </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate('SpecialPage', { productId: item.id })
              }
            >
