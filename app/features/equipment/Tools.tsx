...
type NavigationProp = StackNavigationProp<RootStackParamList, 'ToolsPage'>;
...
export default function ToolsPage() {
  ...
  const [toolsList, setToolsList] = useState<ToolsItem[]>([]);
  const [isLoading, setIsLoading] = useState<boolean>(true);
  const [searchQuery, setSearchQuery] = useState<string>('');

  useEffect(() => {
    const mockData: ToolsItem[] = [...Array(6)].map((_, i) => ({
      id: i + 1,
      title: `Tool ${i + 1}`,
