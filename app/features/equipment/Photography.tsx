...
type RootStackParamList = {
  ...
  PhotographyPage: undefined;
};

type NavigationProp = StackNavigationProp<RootStackParamList, 'PhotographyPage'>;
...
export default function PhotographyPage() {
  ...
  useEffect(() => {
    const mockData: PhotographyItem[] = [...Array(6)].map((_, i) => ({
      id: i + 1,
      title: `Photography Equipment ${i + 1}`,
      image: require('../../../assets/images/tool-placeholder.png'),
      price: '$50/day',
    }));

    setPhotographyList(mockData);
    setIsLoading(false);
  }, []);
  ...
  <View style={{ padding: 16 }}>
    ...
    <View style={styles.headerRow}>
      ...
      <Text style={styles.sectionTitle}>Photography Equipment</Text>
    </View>
