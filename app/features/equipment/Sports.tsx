...
type NavigationProp = StackNavigationProp<RootStackParamList, 'SportsPage'>;
...
export default function SportsPage() {
  ...
  const [sportsList, setSportsList] = useState<SportsItem[]>([]);
  const [isLoading, setIsLoading] = useState<boolean>(true);
  const [searchQuery, setSearchQuery] = useState<string>('');

  useEffect(() => {
    const mockData: SportsItem[] = [...Array(6)].map((_, i) => ({
      id: i + 1,
      title: `Sport Equipment ${i + 1}`,
      image: require('../../../assets/images/tool-placeholder.png'),
      price: '$50/day',
    }));

    setSportsList(mockData);
    setIsLoading(false);
  }, []);
  ...
  <View style={{ padding: 16 }}>
    ...
    <View style={styles.headerRow}>
      ...
      <Text style={styles.sectionTitle}>Sports Equipment</Text>
    </View>
