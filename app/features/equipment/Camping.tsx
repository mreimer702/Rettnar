...
type RootStackParamList = {
  ...
  CampingPage: undefined;
};

type NavigationProp = StackNavigationProp<RootStackParamList, 'CampingPage'>;
...
export default function CampingPage() {
  ...
  useEffect(() => {
    const mockData: CampingItem[] = [...Array(6)].map((_, i) => ({
      id: i + 1,
      title: `Camping Equipment ${i + 1}`,
      image: require('../../../assets/images/tool-placeholder.png'),
      price: '$50/day',
    }));

    setCampingList(mockData);
    setIsLoading(false);
  }, []);
  ...
  <View style={{ padding: 16 }}>
    ...
    <View style={styles.headerRow}>
      ...
      <Text style={styles.sectionTitle}>Camping Equipment</Text>
    </View>
