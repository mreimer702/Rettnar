...
type RootStackParamList = {
  EventsPage: { productId: number };
  // add other routes here if needed
};

// Define Event item type
interface EventItem {
  id: number;
  title: string;
...
export default function EventsPage(): JSX.Element {
  ...
  useEffect(() => {
    // TODO: Backend - Replace this mock data with real event data from API
    const data: EventItem[] = [...Array(6)].map((_, i) => ({
      id: i + 1,
      title: `Event Venue ${i + 1}`,
    ...
    <View style={styles.container}>
      <View style={{ padding: 16 }}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.sectionTitle}>Event Venues</Text>
        </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate('EventsPage', { productId: item.id })
              }
            >
