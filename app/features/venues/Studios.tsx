...
type RootStackParamList = {
  StudioPage: { productId: number };
  // add other routes here if needed
};

// Define Studio item type
...
export default function StudioPage(): JSX.Element {
  ...
  useEffect(() => {
    // TODO: Backend - Replace this mock data with real studio data from API
    const data: StudioItem[] = [...Array(6)].map((_, i) => ({
      id: i + 1,
      title: `Studio Venue ${i + 1}`,
    ...
    <View style={styles.container}>
      <View style={{ padding: 16 }}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.sectionTitle}>Studio Venues</Text>
        </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate('StudioPage', { productId: item.id })
              }
            >
